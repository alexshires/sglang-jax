...
class SchedulerScoringStateMixin:
    ...
    def add_scoring_internal_state(self, ret: dict) -> None:
        ...
        ret["score_scheduler_admission_metrics"] = {
            ...
            "admitted_by_lane": dict(
                SchedulerScoringStateMixin._lane_counter(self, "score_scheduler_lane_admission_admitted")
            ),
            "skipped_by_lane": dict(
                SchedulerScoringStateMixin._lane_counter(self, "score_scheduler_lane_admission_skipped")
            ),
            ...
            "lane_isolation_selected_by_lane": dict(
                SchedulerScoringStateMixin._lane_counter(self, "score_scheduler_lane_isolation_selected")
            ),
            "lane_isolation_empty_turns_by_lane": dict(
                SchedulerScoringStateMixin._lane_counter(self, "score_scheduler_lane_isolation_empty_turns")
            ),
            ...
            "cache_admission_bias": {
                ...
                "candidates_by_lane": dict(
                    SchedulerScoringStateMixin._lane_counter(self, "score_scheduler_cache_admission_candidates")
                ),
                "promoted_by_lane": dict(
                    SchedulerScoringStateMixin._lane_counter(self, "score_scheduler_cache_admission_promoted")
                ),
            },
        }
    ...
    def _iter_waiting_queue(req_owner, waiting_queue: list[Req]) -> list[Req]:
        ...
        lane_waiting_max = SchedulerScoringStateMixin._lane_counter(req_owner, "score_scheduler_lane_waiting_max")
